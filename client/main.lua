...
AddEventHandler('wojtek_burgerownia:wmarkerze', function (zone)
  ...
  elseif zone == 'Smaz' and onDuty == true and sprzataj == false then
    Akt	  = 'smazenie'
	CurrentActionMsg  = ('Kliknij ~INPUT_CONTEXT~ aby ~o~smażyć~w~ mięso')
	CurrentActionData = {}
  ...
  elseif zone == 'Kroj' and onDuty == true and sprzataj == false then
    Akt	  = 'krojenie'
	CurrentActionMsg  = ('Kliknij ~INPUT_CONTEXT~ aby ~o~pokroić ~w~pomidora')
	CurrentActionData = {}
  ...
  elseif zone == 'Przyg' and onDuty == true and sprzataj == false then
	Akt	  = 'przygotuj'
	CurrentActionMsg  = ('Kliknij ~INPUT_CONTEXT~ aby ~o~przygotować~w~ burgera')
	CurrentActionData = {}
  ...
  elseif zone == 'Sprzedaz' and onDuty == true and sprzataj == false then
	Akt	  = 'sell'
	CurrentActionMsg  = ('Kliknij ~INPUT_CONTEXT~ aby ~o~sprzedać~w~ burgera')
	CurrentActionData = {}
  end
end)
...
function MenuLodowki()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cloakroom',
    {
	  ...
	  align    = 'center',
      elements = {
        {label = 'Weź bułkę', value = 'bulka'},
				{label = 'Weź pomidora', value = 'pomidor'},
				{label = 'Weź sałatę', value = 'salata'},
				{label = 'Weź mięso', value = 'mieso'},
